...
function createEmailDetailsHeaderTableDiv(email: EmailInfo): HTMLTableElement {
...
function createEmailDetailsActionsDiv(email: EmailInfo): HTMLDivElement {
    ...
    emailReplyActionDiv.addEventListener("click", (): void => {
        composeEmail();
    ...
    emailReplyAllActionDiv.addEventListener("click", (): void => {
        composeEmail();
    ...
    emailArchiveActionDiv.addEventListener("click", async (): Promise<void> => {
    ...
    emailUnreadActionDiv.addEventListener("click", async (): Promise<void> => {
        const success = await fetchChangeEmailStatus(email.id, {
            read: !email.read,
        });
        if (success) {
