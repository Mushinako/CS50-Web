...
async function likedButtonClickListener(ev) {
    const likeButtonDiv = ev.target;
    ...
    const likeCountNumSpan = byId(`like-count-num-${postId}`);
    ...
    const likeCountPluralSpan = byId(`like-count-plural-${postId}`);
